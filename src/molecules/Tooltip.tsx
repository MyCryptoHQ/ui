...
import type { IconType, BoxProps } from '../atoms';
...
export const Tooltip: FunctionComponent<TooltipProps & BoxProps> = ({
  tooltip,
  icon = 'question',
  fill = 'black',
  placement = 'top',
  ...
  return (
    <>
      <Box ref={setTriggerRef} sx={{ display: 'inline-block' }} {...props}>
